...
// Returns the sum of Q^2 for state in sum. Requires state to be normalized. Else, it returns norm^2 * sum Q^2. Supports max 32 qubits, limited by qubitstate_size and the variables for the loops
